...
| Rank | Prioridade | ID | User Story | Estimativa |
|------|------------|----|------------|------------|
| 1 | ALTA | PS-1 | Como gestor de contratos quero visualizar as marcações que o colaborador fez para saber o total de horas trabalhadas | ? |
| 2 | ALTA | PS-2 | Como gestor de contratos quero visualizar quantos funcionários trabalham em determinado pedíodo para ter controle do número de profissionais no local de trabalho. | ? |
| 3 | ALTA | PS-3 | Como gestor de contratos quero alterar um registro de ponto incorreto para manter a integridade das informações no sistema. | ? |
| 4 | ALTA | PS-4 | Como gestor de contratos quero adicionar empresas no sistema para vincular um funcionário. | ? |
| 5 | ALTA | PS-5 | Como gestor de contratos quero adicionar funcionários no sistema para ter controle dos seus horários de trabalho. | ? |
| 6 | ALTA | PS-6 | Como gestor de contratos quero visualizar as informações de empresas e funcionários através de um dashboard para consultar as informações de forma gráfica. | ? |
| 7 | ALTA | PS-7 | Como gestor de contratos quero extrair relatórios das informações do sistema para realizar uma análise detalhada de uma manutenção. | ? |
| 8 | MÉDIA | PS-8 | Como gestor de contratos quero filtrar tanto a consulta de informações como os relatórios por empresa, funcionário e período para obter informações mais específicas. | ? | 
| 9 | MÉDIA | PS-9 | como gestor de contratos quero criar cargos de funcionarios no sistema para definir o pagamento por hora dos colaboradores. | ? |
| 10 | BAIXA | PS-10 | Como gestor de contratos quero calcular quanto um funcionário receberá com base nas horas trabalhadas e cargo para garantir que as horas trabalhadas sejam devidamente pagas. | ? |
| 11 | MÉDIA | PS-11 | Como gestor de contratos quero que seja exibido um alerta caso haja algum registro incorreto para garantir que todos os registros estejam coerentes. | ? |
